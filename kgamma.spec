...
Version  : 6.3.0
Release  : 17
URL      : https://download.kde.org/stable/plasma/6.3.0/kgamma-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.0/kgamma-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/kgamma-6.3.0.tar.xz.sig
...
%setup -q -n kgamma-6.3.0
cd %{_builddir}/kgamma-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739307136
mkdir -p clr-build
pushd clr-build
