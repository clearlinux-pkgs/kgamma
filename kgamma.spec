...
Version  : 6.1.4
Release  : 9
URL      : https://download.kde.org/stable/plasma/6.1.4/kgamma-6.1.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.4/kgamma-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/kgamma-6.1.4.tar.xz.sig
...
%setup -q -n kgamma-6.1.4
cd %{_builddir}/kgamma-6.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723154515
mkdir -p clr-build
pushd clr-build
