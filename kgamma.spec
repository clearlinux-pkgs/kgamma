...
Version  : 6.2.5
Release  : 15
URL      : https://download.kde.org/stable/plasma/6.2.5/kgamma-6.2.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.5/kgamma-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/kgamma-6.2.5.tar.xz.sig
...
%setup -q -n kgamma-6.2.5
cd %{_builddir}/kgamma-6.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736188053
mkdir -p clr-build
pushd clr-build
