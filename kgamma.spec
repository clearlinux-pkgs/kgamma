...
Source0  : https://download.kde.org/stable/plasma/6.0.4/kgamma-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kgamma-6.0.4.tar.xz.sig
...
%setup -q -n kgamma-6.0.4
cd %{_builddir}/kgamma-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713364265
mkdir -p clr-build
pushd clr-build
