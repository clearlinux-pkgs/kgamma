...
Source0  : https://download.kde.org/stable/plasma/6.1.2/kgamma-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/kgamma-6.1.2.tar.xz.sig
...
%setup -q -n kgamma-6.1.2
cd %{_builddir}/kgamma-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720632965
mkdir -p clr-build
pushd clr-build
