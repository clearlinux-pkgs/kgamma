...
Source0  : https://download.kde.org/stable/plasma/6.1.3/kgamma-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kgamma-6.1.3.tar.xz.sig
...
%setup -q -n kgamma-6.1.3
cd %{_builddir}/kgamma-6.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721168512
mkdir -p clr-build
pushd clr-build
